...
- **Runtime-variable styling (variant, size, state) is expressed via
  ...
  module class; the attribute the component already sets for other reasons
  (ADR-0001) does the styling work. This avoids needing a
  classnames/clsx-style dependency for what's a small, closed set of
  states.
